      ...
      <footer className="border-t border-slate-900 bg-slate-950 py-6 text-center text-xs text-slate-500">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-slate-300">DAR RIDE TANZANIA</span>
            <span>• Africa's Connected Smart Mobility Infrastructure</span>
          </div>
          <div className="flex items-center gap-4 text-slate-400">
            <span>Mwenge • Masaki • Posta • Kariakoo • Coco Beach</span>
            <span>|</span>
            <span className="font-mono text-emerald-400">1,000 IoT Nodes Online</span>
          </div>
        </div>
      </footer>
    </div>
